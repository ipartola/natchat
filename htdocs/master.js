;jQuery(document).ready(function($) {
	...
	// Mechanics
	var socket = new io.Socket(null, {port: location.protocol == 'https:' ? 443 : 80, secure: (location.protocol == 'https:'), transports: ['websocket', 'xhr-multipart', 'xhr-polling', 'htmlfile']}).connect();
	var nicknames = {};
	myId = null;
